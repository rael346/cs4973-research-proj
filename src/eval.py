...
def evaluate_query(ckpt_ver: int, no_finetune: bool):
    ...
    checkpoint = "" if no_finetune else f"lightning_logs/version_{ckpt_ver}/checkpoints/epoch=31-step=3200.ckpt"
    
    # TODO: support for different model size
    # if args.model == "base":
    ...
    GALLERY_EMBS_PATH = f"{result_folder}gallery_embs_b32_512.jsonl"
    PATH_QUERY_FILE = './dataset/query_file_released.jsonl'
    QUERY_EMBS_PATH = f"{result_folder}query_embs_b32_512.jsonl"
...
if __name__ == "__main__":   
    ...
    evaluate_query(args.ckpt, args.nofinetune)